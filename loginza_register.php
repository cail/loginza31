<?php
/**
 * ћодуль Loginza дл€ авторизации через социальные сети и OpenID провайдеров.
 * 
 * ƒанный модуль разработан на основе сервиса Loginza.API (http://loginza.ru/api-overview).
 * ƒанный код можно использовать и модифицировать сохран€€ копирайты и ссылку на http://loginza.ru
 * 
 * @package loginza
 * @version 1.0
